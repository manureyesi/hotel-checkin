<?php
	...
	function getPlantillaSolicitarPagoReservaCliente () {
		$plantillaHtml = '
						   ...
						   <tbody>
							  <tr>
								 <td id="x_header_wrapper" style="padding:36px 48px; display:block">
									<h1 style="color:#ffffff; font-family:&quot;Helvetica Neue&quot;,Helvetica,Roboto,Arial,sans-serif; font-size:30px; font-weight:300; line-height:150%; margin:0">Se requiere el pago de su reserva</h1>
								 </td>
							  </tr>
						   </tbody>
						</table>
										  ...
										  <tr>
											 <td style="padding:48px" valign="top">
												<div id="x_body_content_inner" style="color: rgb(177, 177, 177) !important; font-family: &quot;Helvetica Neue&quot;, Helvetica, Roboto, Arial, sans-serif; font-size: 14px; line-height: 150%;" data-ogsc="rgb(115, 115, 115)">
												   <p style="margin:0 0 16px">Estimado/a %NOMBRE% %APELLIDO%, su reserva está aprobada, para conservar la reserva es necesarío que realize el pago en el siguiente enlace:</p>
												   <a href="%URL_PAGO%">Realizar pago</a></br>
												   <h4>Detalles de reserva</h4>
												   <p style="margin:0 0 16px">ID: #%ID_RESERVA%<br aria-hidden="true">Llegada: : %FECHA_LLEGADA%, hasta las %HORA_PERMITIDA_LLEGADA%<br aria-hidden="true">Salida: %FECHA_SALIDA%, hasta las %HORA_PERMITIDA_SALIDA%<br aria-hidden="true"><br aria-hidden="true"><a href="%BASE_URL%/confirmacion-de-reserva/reserva-confirmada/?booking_id=%ID_RESERVA%&amp;booking_key=%BOOKING_KEY%" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="color: rgb(141, 180, 218) !important; font-weight: normal; text-decoration: underline;" data-linkindex="0" data-ogsc="rgb(85, 125, 161)">Ver reserva</a> <br aria-hidden="true"></p>
												   <h4>Alojamiento #1</h4>
